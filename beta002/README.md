**v.0.0.2b(202503010100)**

# HydraRoute mod(minimal domain)
...
```
opkg install curl && curl -Ls "https://raw.githubusercontent.com/pegakmop/HydraRoute/refs/heads/master/beta002/hydra.sh" | sh
```
